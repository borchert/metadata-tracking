...
http://www.co.otter-tail.mn.us/212/GIS-Shapefile-Downloads

Zip file Contents:
README_TOWNSHIPS.TXT (this file)
Townships.cpg
townships.dbf
townships.prj
townships.shp
townships.shp 	(XML document)
townships.shx
townships   	(Adobe Tsune file) optional
...
DISCLAIMER: The information on www.co.otter-tail.mn.us is made available as a public service. Maps and data are to be used for reference purposes only, anThe information on cadastral maps is used to locate, identify and inventory parcels of land in Otter Tail County for REFERENCE ONLY and is NOT TO BE CONSTRUED OR USED AS A LEGAL DESCRIPTION.
